...
//    runner.printAllRows("TEST_BURDETTE");
  ...
  public void createAllTables() throws SQLException {
    ...
    String[] table_statements =
            {"CREATE TABLE PERSON (Login VARCHAR(16) NOT NULL, Pwd VARCHAR(16) NOT NULL, Email VARCHAR(320) NOT NULL, PRIMARY KEY (Login))",
                    ...
                    "CREATE TABLE MODERATOR (Moderator_Login VARCHAR(16) NOT NULL, Man_Login VARCHAR(16), Pe_Login VARCHAR(16) NOT NULL, PRIMARY KEY (Moderator_Login), FOREIGN KEY (Man_Login) REFERENCES MANAGER(Manager_Login), FOREIGN KEY (Pe_Login) REFERENCES (Login))",
                    ...
                    "CREATE TABLE ITEM (ID INT NOT NULL, Volume INT NOT NULL, Weight INT NOT NULL, L_ID INT, O_Name VARCHAR(32), W_Name VARCHAR(32), PRIMARY_KEY (ID), FOREIGN KEY (L_ID) REFERENCES LOCATION(L_ID), FOREIGN KEY (O_Name) REFERENCES P_CHARACTER(L_ID), FOREIGN KEY (W_Name) REFERENCES P_CHARACTER(L_ID))",
  ...
  public void dropAllTables() throws SQLException {
    ...
    String[] table_statements =
            {"DROP TABLE PERSON",
                    "DROP TABLE TEST_BURDETTE",
                    "DROP TABLE MANAGER",
                    "DROP TABLE MODERATOR",
                    "DROP TABLE PLAYER",
                    "DROP TABLE LOCATION",
                    "DROP TABLE P_CHARACTER",
                    "DROP TABLE LOCATION_EXITS_TO_LOCATION",
                    "DROP TABLE CREATURE",
                    "DROP TABLE ABILITY",
                    "DROP TABLE CREATURE_HAS_POSSIBLE_AREAS",
                    "DROP TABLE CREATURE_LIKES_HATES_PLAYER",
                    "DROP TABLE CREATURE_LIKES_HATES_CREATURE",
                    "DROP TABLE ITEM",
                    "DROP TABLE CONTAINER",
                    "DROP TABLE ARMOR",
                    "DROP TABLE WEAPON",
                    "DROP TABLE GENERIC_ITEM"
            };
